...
export class CreateReservationDto {
  ...
  @ApiProperty({ example: 20, required: false, description: "Pourcentage de réduction (offre promo), 0 à 100" })
  @IsOptional()
  @IsNumber({}, { message: 'Le pourcentage de promo doit être un nombre' })
  @Min(0, { message: 'Le pourcentage de promo ne peut pas être négatif' })
  @Max(100, { message: 'Le pourcentage de promo ne peut pas dépasser 100' })
